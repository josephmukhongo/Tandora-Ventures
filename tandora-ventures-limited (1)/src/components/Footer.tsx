      ...
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="pt-2 text-xs space-y-1.5 text-slate-300">
            <div className="flex items-center gap-2">
              ...
              <span><strong>Headquarters:</strong> Commercial District, Nairobi, Kenya</span>
            </div>
            <div className="flex items-center gap-2">
              <MapPin className="w-4 h-4 text-blue-400 shrink-0" />
              <span><strong>Operational Address:</strong> Port & Logistics Hub, Mombasa, Kenya</span>
            </div>
            <div className="flex items-center gap-2">
              <Globe className="w-4 h-4 text-emerald-400 shrink-0" />
              <span>Pan-African Regional Network: Kenya, Uganda, Tanzania, Rwanda, DRC & Global Trade Desk</span>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-3 text-xs">
            ...
            <a
              href="/tandora-ventures-limited.zip"
              download="tandora-ventures-limited.zip"
              className="mt-2 bg-emerald-900/60 hover:bg-emerald-800 text-emerald-300 font-bold p-2.5 rounded-lg border border-emerald-700/60 flex items-center justify-center gap-1.5 transition text-xs"
            >
              <FileText className="w-4 h-4 text-emerald-400" />
              <span>Download Project ZIP File</span>
            </a>
          </div>
        </div>
