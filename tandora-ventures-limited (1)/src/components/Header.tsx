        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-2">
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <span className="hidden lg:inline-flex items-center gap-1 text-slate-300">
              ...
              HQ: Nairobi, Kenya • Address: Mombasa, Kenya
            </span>
          </div>
          ...
          <div className="flex items-center gap-4 flex-wrap text-slate-300">
            ...
            <a
              ...
              className="bg-emerald-950/80 hover:bg-emerald-900 text-emerald-400 font-bold px-2.5 py-0.5 rounded border border-emerald-800/60 flex items-center gap-1 transition"
