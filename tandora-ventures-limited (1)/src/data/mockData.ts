...
export const MANAGING_DIRECTOR = {
  ...
  location: "Headquarters: Nairobi, Kenya | Regional Office: Mombasa, Kenya",
  headquarters: "Commercial District, Nairobi, Kenya",
  regionalAddress: "Port & Logistics Hub, Mombasa, Kenya",
