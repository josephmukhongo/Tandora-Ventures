            ...
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8 space-y-6 shadow-xl">
              ...
              <div className="space-y-4 pt-2 border-t border-slate-800 text-xs">
                ...
                <div className="bg-slate-950 p-3.5 rounded-xl border border-slate-800 flex items-center gap-3">
                  <div className="w-9 h-9 rounded-lg bg-slate-800 text-slate-300 flex items-center justify-center font-bold shrink-0">
                    <MapPin className="w-4 h-4 text-amber-400" />
                  </div>
                  <div>
                    <div className="text-[10px] text-slate-400 uppercase font-bold">Headquarters</div>
                    <div className="text-xs font-bold text-white">Nairobi Commercial District, Kenya</div>
                  </div>
                </div>
